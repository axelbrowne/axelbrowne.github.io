  ...
  return (
    ...
    <div className="right-panel">
      <div className="projects">
        <a href="https://github.com/damianbrowne/pucksim" target="_blank" className="proj-card">
        ...
        <a href="https://github.com/damianbrowne/FASim-NFAConverter" target="_blank" className="proj-card">
        ...
        <a href="https://github.com/damianbrowne/portfolio-website" target="_blank" className="proj-card">
          <h3 className="proj-title">damianbrowne.dev</h3>
          <p className="proj-desc">
